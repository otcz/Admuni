...
package municione.E_verRegistro.vista;
...
import municione.E_verRegistro.modelo.Jtable;
...
public class VerRegistro extends JFrame {
    ...
    private void initComponents() {
        ...
        btnBuscar.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/VerRegistro.png"))); // NOI18N
