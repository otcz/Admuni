...
import municione.B_menuPrincipal.control.*;
...
public class Principal extends JFrame {
    ...
    public Principal() {
        ...
        lbFondo.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/blue2-1686530_960_720 (1).jpg")));
        ...
        jmArchivo.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/Archivo.png"))); // NOI18N
        ...
        jmVerRegistro.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/VerRegistro.png"))); // NOI18N
        ...
        jmArchivo1.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/estadistica.png"))); // NOI18N
        ...
        jmiCrearMunicion1.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/Nuevo.png"))); // NOI18N
        ...
        jmCrearTipoMunicion1.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/cajaMuni32.png"))); // NOI18N
        ...
        jmArchivo2.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/ayuda.png"))); // NOI18N
        ...
        jmiCrearMunicion2.setIcon(new ImageIcon(getClass().getResource("/municione/imagen/Nuevo.png"))); // NOI18N
        jmiCrearMunicion2.setText("NUEVO REGISTRO");
