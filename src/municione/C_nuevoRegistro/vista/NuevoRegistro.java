...
import municione.C_nuevoRegistro.modelo.TituloTabla;
...
public class NuevoRegistro extends JFrame {
    ...
    private void initComponents() {
        ...
        cbTipoMuni.setModel(new DefaultComboBoxModel<>(new String[]{"ER50", "M101"}));
        ...
        textUbicacion.setBorder(BorderFactory.createTitledBorder(null, "UBICACIÓN", TitledBorder.LEFT, TitledBorder.ABOVE_TOP, new Font("Roboto", 1, 14), new Color(255, 255, 255))); // NOI18N
